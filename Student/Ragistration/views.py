...
def index(request):
    return render(request,"Ragistration/index.html")
...
def apply(request):
    ...
    return render(request,"Ragistration/apply.html",{'app': app})
...
def welcome(request):
    ...
    if request.method == 'POST':
        try:
            ...
            return render(request, 'Ragistration/thanks.html',{'count': count})

        except IntegrityError as e:
            e = 'You Allready Apply'
            return render(request, "Ragistration/thanks.html",context={ 'e': e,'count': count})
    ...
    return render(request, 'Ragistration/welcome.html',{'app1': app1})

def thanks(request):
        
    
    return render(request, 'Ragistration/thanks.html')
    ...
    if form.is_valid():
        ...
        if password1==password2:
            try:
                ...
                return render(request, 'Ragistration/signup.html', context)
...
def signin(request):
    if request.method == 'POST': 
        ...
        return render(request,'Ragistration/signin.html')
...
def about(request):
    return render(request,"Ragistration/about.html")
...
def contact(request):
    ...
    if request.method == 'POST':
            if request.POST.get('name') and request.POST.get('email') and request.POST.get('mobile') and request.POST.get('college') and request.POST.get('subject') and request.POST.get('feedback'):
                ...
                return render(request, 'Ragistration/contact.html')
